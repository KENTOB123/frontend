  ...
  const HomeRightbar = () => {
    return (
      <>
        ...
        <p className="promotionName">kent株式会社</p>
        </>
    )
  }
      ...
      <div className="rightbarInfo">
        ...
        <div className="rightbarFollowings">
          <div className="rightbarFollowing">
            ...
            <span className="rightbarFollowingName">Ketno</span>
          </div>
          <div className="rightbarFollowing">
            <img src={PUBLIC_FOLDER + "/person/2.jpeg"} alt="" className="rightbarFollowingImg" />
            <span className="rightbarFollowingName">kevin</span>
          </div>
          <div className="rightbarFollowing">
          ...
          <div className="rightbarFollowing">
            ...
            <span className="rightbarFollowingName">chole</span>
          </div>
          <div className="rightbarFollowing">
            <img src={PUBLIC_FOLDER + "/person/5.jpeg"} alt="" className="rightbarFollowingImg" />
            <span className="rightbarFollowingName">yamm</span>
          </div>
        </div>
      </div>
    </>
